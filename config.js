const config = {
  ...
  header: {
    ...
    title:
      "<a href='http://localhost:8000/'><img class='img-responsive' src='https://graphql-engine-cdn.hasura.io/learn-hasura/assets/homepage/learn-logo.svg' alt='Learn logo' /></a>",
    githubUrl: '',
    helpUrl: '',
    tweetText: '',
    // social: `<li>
